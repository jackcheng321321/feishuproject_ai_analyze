...
- 📁 **多协议文件获取**: 基于飞书项目字段路径，支持SMB、NFS、FTP、HTTP等协议获取其他系统或本地网盘文件
- 🤖 **AI模型支持**: 集成Google Gemini等AI服务（其他模型正在测试验证中）
...
- ✅ **多协议文件获取**: 基于飞书项目字段路径，SMB/NFS/FTP/HTTP协议获取其他系统或本地网盘文件
- ✅ **AI模型管理**: 支持Google Gemini等AI服务，可配置参数和代理（其他模型测试中）
...
- **AI集成**: Google Gemini等（其他AI模型正在测试验证中）
